        ...
        <div className="max-w-3xl mx-auto flex flex-col sm:flex-row items-center sm:items-start gap-6">
          ...
          <div>
            ...
            <div className="flex items-center gap-3 flex-wrap">
              ...
              <a href="https://www.instagram.com/felipeeeeoliveira" target="_blank" rel="noopener noreferrer"
                className="text-xs text-[#888] hover:text-white transition-colors flex items-center gap-1.5 border border-[#2a2a2a] rounded-xl px-3 py-2 hover:border-[#444]">
              ...
              <a href="https://www.linkedin.com/in/felipe-oliveira-327052252/" target="_blank" rel="noopener noreferrer"
                className="text-xs text-[#888] hover:text-white transition-colors flex items-center gap-1.5 border border-[#2a2a2a] rounded-xl px-3 py-2 hover:border-[#444]">
