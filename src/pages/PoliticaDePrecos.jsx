...
const CONTENT = {
  "pt-BR": {
    ...
    step4: "Repasse via Pix",
    step4Desc: "Durante o piloto, o repasse é feito manualmente pela nossa equipe via Pix, em até 2 dias úteis após o acerto, líquido da taxa.",
  ...
  en: {
    ...
    step4: "Pix payout",
    step4Desc: "During the pilot, payouts are sent manually by our team via Pix, within 2 business days after settlement, net of fee.",
